...
from gridagents.environments.savanna_safetygrid import (
    GridworldZooBaseEnv,
    ACTION_RELATIVE_COORDINATE_MAP,
)

from gridagents.agents.handwritten_rules.savanna_safetygrid_handwritten_rules import (
    savanna_safetygrid_available_handwritten_rules_dict,
    format_float,
)

from gridagents.agents.q_agent import QAgent
from gridagents.gridagents_typing import ObservationFloat, PettingZooEnv
...
logger = logging.getLogger("gridagents.agents.sb3_handwritten_rules_expert")
...
class SB3HandWrittenRulesExpert(object):
    ...
    def init_handwritten_rules(self) -> None:
        if self.env_classname in [
            "gridagents.environments.savanna_safetygrid.GridworldZooBaseEnv"
