...
from gridagents.environments.ai_safety_gridworlds.savanna import (  # TODO: import agent char map from env object instead?; AGENT_CHR3,
    AGENT_CHR1,
    AGENT_CHR2,
    DRINK_CHR,
    FOOD_CHR,
...
from gridagents.gridagents_typing import Reward  # TODO: use np.ndarray or mo_reward
from gridagents.gridagents_typing import (
    AgentId,
    Info,
    Observation,
    ObservationFloat,
...
logger = logging.getLogger("gridagents.environments.savanna_safetygrid")
...
class GridworldZooBaseEnv:
    ...
    def __init__(
        ...
        self.super_initargs = {
            "env_name": "ai_safety_gridworlds.savanna"
